...
//                "Best services provided by anacell, everyone should use anacell",};
    ...
    private static List<String> solve(int k, String[] keywords, String[] reviews) {
        ...
        PriorityQueue<Map.Entry<String, Integer>> maxHeap = new PriorityQueue<>((a, b) -> Objects.equals(a.getValue(), b.getValue()) ? a.getKey().compareTo(b.getKey()) : b.getValue() - a.getValue());
