 ...
 * the retrieval is O(1), but if the original array is updated we need to compute
...
public class FenwickTree{
    ...
    // a dummy entry, the trees are arranged in set bits of each array's index
    // we consider 4 pos of the bit representation
    /**
     * for array [1,-7,15,9,4,2,0,10]
     * 0=>               [0/0000]                       (index/ bit val of index)
     *         /        |        \            \
     * 1=>  [1/0001]   [2/0010]   [4/0100]    [8/1000]   - level of indexes with 1 right set bit (flipping right most bit will get parent)
     *              /             /     \
     * 2=>      [3/0011]      [5/0101]  [6/0110]         - level of indexes with 2 right set bit (flipping right most bit will get parent)
     *                                    /
     * 3=>                              [7/0111]         - level of indexes with 3 right set bit (flipping right most bit will get parent)
     * 
     ...
     * [1,-7,15,9,4,2,0,10]=> [1,-6,9,18,22,24,24,34] and update in its position in fenwick tree
     * 
     *               [0/0000]                     
     *         /        |        \            \
     ...
     *                                    /
     *                               [24/0111]
     * then we need to subtract each cell's value to its immediate parent's value, while traversing (through parent )we can add parent's value to
     * get the correct ans.
     *
